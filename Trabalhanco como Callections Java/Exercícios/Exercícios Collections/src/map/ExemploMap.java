...
public class ExemploMap {
    public static void main(String[] args) {
        ...
        System.out.println("Crie um dicionário que relacione modelos de carros e seus repectivos consumo");
        ...
        System.out.println("Remova os modelos com o consumo igual a 15,5 km/l");
